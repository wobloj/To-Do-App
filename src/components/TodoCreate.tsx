...
export const TodoCreate = () => {
  ...
  return (
    <div className="text-center mx-20 w-full">
        <h3 className="text-3xl mb-20">Create new TODO tasks</h3>
        ...
        <form className="flex flex-col items-center min-h-32">
          {activeStep === 0 &&
            <>
              <p className="text-xl font-light mb-20">Enter Your TODO tasks title</p>
              <Input 
                ...
                label="title" 
                title="Title" 
                className="min-w-72 mb-10 text-center"/>
            </>
          }
